...
func (_m *MockEventHandler) HandleFakeEvent(ctx context.Context, e fake.Event) werrors.WError {
	ret := _m.Called(ctx, e)
	...
	if rf, ok := ret.Get(0).(func(context.Context, fake.Event) werrors.WError); ok {
		r0 = rf(ctx, e)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockEventHandler_HandleFakeEvent_Call) Return(_a0 werrors.WError) *MockEventHandler_HandleFakeEvent_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockEventHandler_HandleFakeEvent_Call) RunAndReturn(run func(context.Context, fake.Event) werrors.WError) *MockEventHandler_HandleFakeEvent_Call {
	_c.Call.Return(run)
	return _c
}
