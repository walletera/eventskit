...
func (_m *MockEventData) AggregateVersion() uint64 {
	ret := _m.Called()
...
// MockEventData_AggregateVersion_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AggregateVersion'
type MockEventData_AggregateVersion_Call struct {
	*mock.Call
}

// AggregateVersion is a helper method to define mock.On call
func (_e *MockEventData_Expecter) AggregateVersion() *MockEventData_AggregateVersion_Call {
	return &MockEventData_AggregateVersion_Call{Call: _e.mock.On("AggregateVersion")}
}

func (_c *MockEventData_AggregateVersion_Call) Run(run func()) *MockEventData_AggregateVersion_Call {
...
func (_c *MockEventData_AggregateVersion_Call) Return(_a0 uint64) *MockEventData_AggregateVersion_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockEventData_AggregateVersion_Call) RunAndReturn(run func() uint64) *MockEventData_AggregateVersion_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockEventData) CreatedAt() time.Time {
	ret := _m.Called()
...
// MockEventData_CreatedAt_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreatedAt'
type MockEventData_CreatedAt_Call struct {
	*mock.Call
}

// CreatedAt is a helper method to define mock.On call
func (_e *MockEventData_Expecter) CreatedAt() *MockEventData_CreatedAt_Call {
	return &MockEventData_CreatedAt_Call{Call: _e.mock.On("CreatedAt")}
}

func (_c *MockEventData_CreatedAt_Call) Run(run func()) *MockEventData_CreatedAt_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockEventData_CreatedAt_Call) Return(_a0 time.Time) *MockEventData_CreatedAt_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockEventData_CreatedAt_Call) RunAndReturn(run func() time.Time) *MockEventData_CreatedAt_Call {
	_c.Call.Return(run)
	return _c
}
